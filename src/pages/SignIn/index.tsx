...
export default function SignIn() {
  ...
  const { registerUser } = useLoginUser();
  ...
  return (
    ...
    >
      ...
      >
        ...
        "
        >
          Iniciar sesión <span className="text-blue-500">Genios Data</span>
        </h1>
        ...
        <div className="w-full flex flex-col gap-2 mt-4">
          ...
          >
            ...
            <Link to="/sign-up">
              <span className="font-bold text-blue-500">Regístrate aquí</span>
            </Link>
          </p>
          <Link to="/">
            <span
